...
public class UpdateUserShippingAddressCommandValidator : AbstractValidator<UpdateUserShippingAddressCommand>
{
    public UpdateUserShippingAddressCommandValidator()
    {
