...
using Infrastructure.Data.Repositories.Coupons;
...
public class UnitOfWork(AppDbContext context) : IUnitOfWork
{
    ...
    public ICouponRepository Coupons => field ??= new CouponRepository(context);
    public IUserCouponRepository UserCoupons => field ??= new UserCouponRepository(context);
